...
final class UpdateManager: ObservableObject {
    ...
    private let releasesURL = URL(string: "https://api.github.com/repos/iamadarsha/FlowKeys/releases/latest")!
    ...
    func checkForUpdates(userInitiated: Bool) async {
        let currentBuildTag = Bundle.main.infoDictionary?["FlowKeysBuildTag"] as? String
    ...
    func showUpdateAlert() {
        ...
        alert.informativeText = "A new version of FlowKeys (released \(latestReleaseDate)) is available.\n\nWould you like to download the update?"
    ...
    private func showRecentReleaseAlert(daysSincePublished: Double) {
        ...
        alert.informativeText = "A new version of FlowKeys was released \(ageText). It's very recent — you can download it now or wait a few days for stability.\n\nWould you like to download it?"
        alert.alertStyle = .informational
        alert.icon = NSApp.applicationIconImage
    ...
    func showUpToDateAlert() {
        ...
        alert.informativeText = "You're running the latest version of FlowKeys."
        alert.alertStyle = .informational
        alert.icon = NSApp.applicationIconImage
    ...
    private func performUpdate(downloadURL: URL, expectedSize: Int) async {
        ...
        let tempDir = fm.temporaryDirectory.appendingPathComponent("flowkeys-update-\(UUID().uuidString)")
        ...
        let dmgPath = tempDir.appendingPathComponent("FlowKeys.dmg")
        ...
        do {
            ...
            let stagingDir = fm.temporaryDirectory.appendingPathComponent("flowkeys-staged-\(UUID().uuidString)")
